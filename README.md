...
$ git restore -- staged <file> - переведет фаил из STAGED обратно в MODIFIED или UNTRACKED.<br>
$ git reset -- hard <commit hash> - откатит историю до коммита с хешем <Hash>. Более позние коммиты потеряются. <br>
$ git log --online # ищем хешь для удаления.<br>
7b972f5
b576d89 
$ 
